            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {exercise.flag && (
                    <span className="text-[0.625rem] px-1.5 py-0.5 rounded bg-warning/20 text-warning font-bold uppercase shrink-0">
                      {exercise.flag}
                    </span>
                  )}
                </div>
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  {exercise.muscle && (
                    <span className="text-[0.625rem] px-1.5 py-0.5 rounded-md bg-accent-blue/10 text-accent-blue font-medium truncate min-w-0">
                      {exercise.muscle}
                    </span>
                  )}
                </div>
                {exercise.note && (
                  <p className="text-[0.6875rem] text-text-muted mt-0.5 truncate">
                    {exercise.note}
                  </p>
                )}
              </div>
