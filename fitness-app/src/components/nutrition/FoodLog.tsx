          ...
          {confirming ? (
            <div className="flex-shrink-0 flex items-center gap-1">
              <button
                ...
                className="text-[0.6875rem] px-2 py-0.5 rounded bg-surface text-text-muted hover:text-text-primary transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="text-[0.6875rem] px-2 py-0.5 rounded bg-danger text-white hover:bg-danger/80 transition-colors"
              >
                Delete
              </button>
            </div>
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center justify-between px-1 mb-1">
        <span className="text-[0.6875rem] text-text-muted">{entries.length} entries</span>
        <span className="text-[0.6875rem] text-text-muted">{totalCalories} cal total</span>
      </div>
      {entries.map((entry) => (
        <SwipeableEntry
          key={entry.id}
