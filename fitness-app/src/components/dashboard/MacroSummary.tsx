...
export default function MacroSummary({ totals, targets, fiberTarget = 30 }: MacroSummaryProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <MacroBar label="Fiber"    current={totals.fiber}    target={fiberTarget}      unit="g" />
      </div>
    </div>
  );
}
