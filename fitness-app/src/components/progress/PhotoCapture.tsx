...
export function PhotoCapture({ existingPhotos, onSave, onClose }: Props) {
  ...
  const referencePhoto = existingPhotos
    ...
    <div className="space-y-5">
      ...
      {showCropper && rawImageUrl && (
        <ProgressPhotoCropper
          ...
          referenceImageSrc={referencePhoto ? getImageSrc(referencePhoto.imageData) : undefined}
