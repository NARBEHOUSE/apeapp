    ...
    <div className="fixed bottom-20 left-4 right-4 z-40 max-w-lg mx-auto animate-in slide-in-from-bottom">
      <div className="bg-surface rounded-2xl shadow-lg border border-border p-4 space-y-3">
        ...
        <div>
          ...
          {detail && <div className="text-[0.6875rem] text-text-muted mt-0.5">{detail}</div>}
        </div>
        ...
        <div className="text-[0.5625rem] text-text-muted text-center">Say "yes" to confirm · Voice mode is in beta</div>
      </div>
    </div>
  );
}
